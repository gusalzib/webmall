  ...
  <div class="signup-container">
    <form id="signup-form" class="signup-form"  method="POST">
      *Required
        ...
        <input v-model="buyer.fname" type="text" id="fname" required/>
        </br> 
        <label>Last name:* </label>
        <input v-model="buyer.lname" type="text" id="lname" required/>
        </br>
        <label>Middle name:* </label>
        <input v-model="buyer.minit" type="text" id="minit" required/>
        </br>
        <label>Phone number:* </label>
        <input v-model="buyer.phone_number" type="text" id="phone_number" required/>
        </br>
        <label>Email:* </label>
        <input v-model="buyer.email" type="email" id="email" required/>
        </br>
        <label>Street:* </label>
        <input v-model="buyer.street" type="text" id="street" required/>
        </br>
        <label>Zipcode:* </label>
        <input v-model="buyer.zipcode" type="text" id="zipcode" required/>
        </br>
        <label>City:* </label>
        <input v-model="buyer.city" type="text" id="city" required/>
        </br>
        <label>Password:*</label>
        <input v-model="buyer.password" type="password" id="password" required/>
